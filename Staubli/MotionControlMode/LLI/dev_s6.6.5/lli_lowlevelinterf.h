...
S_EXPORT LLI_Status LLI_recInit(LLI_RobotId x_robotId, const char* x_pFilePath);
S_EXPORT LLI_Status LLI_recStart(LLI_RobotId x_robotId);
S_EXPORT LLI_Status LLI_recStop(LLI_RobotId x_robotId);
S_EXPORT LLI_Status LLI_recStore(LLI_RobotId x_robotId,const char* x_pFilePath);
